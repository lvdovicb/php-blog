...
--
-- Hôte : mysql:3306
-- Généré le :  lun. 19 fév. 2018 à 14:30
...
CREATE TABLE `posts` (
  ...
  `id_users` int(255) UNSIGNED NOT NULL
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
